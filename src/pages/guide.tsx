...
import { Chip, Section, renderPage } from "./layout.tsx";
...
export function guidePage(): Response {
  return renderPage({
    ...
    children: (
      <>
        <Section title="对话命令" description="直接在微信聊天窗口发送，Bot 会即时响应。" dot="wechat">
          <div class="grid">
        ...
        <Section title="记忆" description="Bot 会自动从对话中提取并持久化用户偏好与事实，无需手动操作。" dot="purple">
          <div class="grid">
        ...
        <Section title="管理台操作" description="浏览器端管理配置，无需修改代码。" dot="brand">
          <div class="grid">
            <div class="card stack">
